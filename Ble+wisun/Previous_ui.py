...
def  but_start_wisun():
    ...
    if wisun_setup:
        ...
        root.update_idletasks()
        keyboard_input(click_start_charge)
        ...
        root.update_idletasks()
        keyboard_input(click_start_button)
        ...
        try:
            ...
            if(1):
                ...
                while(energy_cons < netenergy ):
                    print("\r", f"units_cons = {energy_cons/unit_1: .2f}", end='\r')
                    energy_cons = (power*(time.time()-start))
